...
_GENRE_CHOICES: dict[str, dict[str, list[str]]] = {
    "chords": {
        ...
        "tech_house": ["Wavetable", "Operator", "Drift", "Meld"],
        "dub_techno": ["Analog", "Drift", "Wavetable", "Meld"],
        "deep_house": ["Electric", "Analog", "Wavetable", "Drift"],
        "minimal_techno": ["Drift", "Analog", "Wavetable", "Meld"],
        "dub": ["Analog", "Drift", "Wavetable", "Electric"],
        "funk": ["Electric", "Drift", "Wavetable", "Analog"],
    ...
    "bass": {
        ...
        "tech_house": ["Operator", "Wavetable", "Drift", "Meld"],
        "dub_techno": ["Analog", "Operator", "Drift", "Wavetable"],
        "deep_house": ["Operator", "Analog", "Wavetable", "Drift"],
        "minimal_techno": ["Operator", "Drift", "Analog", "Wavetable"],
        "dub": ["Analog", "Operator", "Drift", "Wavetable"],
        "funk": ["Electric", "Operator", "Drift", "Analog"],
    ...
    "melody": {
        ...
        "edm": ["Wavetable", "Meld", "Operator", "Drift"],
        "tech_house": ["Wavetable", "Operator", "Meld", "Drift"],
        "dub_techno": ["Wavetable", "Analog", "Meld", "Drift"],
        "deep_house": ["Electric", "Wavetable", "Analog", "Drift"],
        "minimal_techno": ["Meld", "Wavetable", "Drift", "Operator"],
        "dub": ["Wavetable", "Analog", "Electric", "Drift"],
        "funk": ["Electric", "Wavetable", "Operator", "Drift"],
